...
uint8 GETucCommonBlockInitializeEE( Rte_Instance self)
{
  return( ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucInitialize);
}

void PUTucCommonBlockInitializeEE( Rte_Instance self, uint8 ucNvmInitialize)
{
  ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucInitialize = ucNvmInitialize;
}

tPressureUnitType GETucUnAipEE( Rte_Instance self)
{
  return( (tPressureUnitType) ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucUnitPressure);
}

void PUTucUnAipEE( Rte_Instance self, tPressureUnitType ucLastUnAip)
{
  ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucUnitPressure = (uint8) ucLastUnAip;
}

tTemperatureUnitType GETucUnTempEE( Rte_Instance self)
{
  return( (tTemperatureUnitType) ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucUnitTemperature);
}

void PUTucUnTempEE( Rte_Instance self, tTemperatureUnitType ucLastUnTemp)
{
  ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucUnitTemperature = (uint8) ucLastUnTemp;
}

tMileageUnitType GETucUnMileEE( Rte_Instance self)
{
  return( (tMileageUnitType) ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucUnitSpeed);
}

void PUTucUnMileEE( Rte_Instance self, tMileageUnitType ucLastUnMile)
{
  ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ucUnitSpeed = (uint8) ucLastUnMile;
}

Rdci_MILE_KM_Type GETulMileKmEE( Rte_Instance self)
{
  return( ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ulKm);
}

void PUTulMileKmEE( Rte_Instance self, Rdci_MILE_KM_Type ulLastMileKm)
{
  ((tCommonNvmBlockType *) (void *) Rte_Pim_NvmRdciCommonBlock_NVBlock_MirrorBlock( self)->Data)->ulKm = ulLastMileKm;
}
