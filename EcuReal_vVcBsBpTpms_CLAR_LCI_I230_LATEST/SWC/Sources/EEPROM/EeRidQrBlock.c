...
void    SetRidQrBlock1UpdateFlagEE   (void){bBlock1NeedsUpdate = TRUE;}
void    SetRidQrBlock2UpdateFlagEE   (void){bBlock2NeedsUpdate = TRUE;}
void    ClearRidQrBlock1UpdateFlagEE (void){bBlock1NeedsUpdate = FALSE;}
